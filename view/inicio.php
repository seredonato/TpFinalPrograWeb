    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active imagencarousel">
                <img class="d-block w-100 " src="view/images/indexfoto1.png" alt="First slide">
                <h4 class="text-center">Todos los dias cumpliendo nuestro trabajo</h4>
            </div>
            <div class="carousel-item imagencarousel">
                <img class="d-block w-100" src="view/images/indexfoto2.png" alt="Second slide">
                <h4 class="text-center">Tomamos muchas rutas, pero solo un camino: hacer nuestro trabajo</h4>
            </div>
            <div class="carousel-item imagencarousel">
                <img class="d-block w-100" src="view/images/indexfoto3.png" alt="Third slide">
            ...
            <div class="carousel-item imagencarousel">
                <img class="d-block w-100" src="view/images/indexfoto4.png" alt="Third slide">
                <h4 class="text-center">Con personal capacitado, en regla y que cumplen con los protocolos</h4>
            </div>
            <div class="carousel-item imagencarousel">
                <img class="d-block w-100" src="view/images/indexfoto5.png" alt="Third slide">
    ...
    <div class="container mt-2 justify-content-center">
        ...
        <div class="row my-5">
            <div class="col-md-4">
                ...
                <img src="view/images/logoQ.jpg" class="card-img-top" alt="...">
                <div class="card-body">
